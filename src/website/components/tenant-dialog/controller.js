...
export default [
  '$rootScope', '$scope', '$http', 'appConfig', '$uibModalInstance', 'TenantApi', 'UserApi', 'tenant',
  class Controller extends BaseController {
    constructor($rootScope, $scope, $http, appConfig, $uibModalInstance, TenantApi, UserApi, tenant) {
      super()
      this.$http = $http;
      this.$scope = $scope;
